...
init-db:
	DEUTSCH_ADMIN_PASSWORD="$${ADMIN_PASSWORD:-123456678}" go run ./cmd/dbinit -f "$${CONFIG_FILE:-etc/deutsch.yaml}" -admin-username "$${ADMIN_USERNAME:-admin}" -admin-email "$${ADMIN_EMAIL:-admin@example.com}"
